...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
		...
		<center><h2 style="margin-top:1px;">İş Takip Uygulaması</h2></center>
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  <div class="form-heading">
			    <h2 class="text-center">Giriş Paneli</h2>
			  </div>
			  ...
			  <div class="form-group" ng-class="{'has-error': loginForm.password.$invalid && loginForm.password.$dirty, 'has-success': loginForm.password.$valid}">
			    <input type="password" class="form-control" placeholder="şifre" name="admin_password" required/>
			  </div>
			  <button type="submit" name="login_btn" class="btn btn-primary pull-right">Giriş Yap</button>
			</form>
		</div>
	</div>
</div>
