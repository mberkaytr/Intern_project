      ...
      <div class="col-md-12">
        <div class="well well-custom">
          <ul class="nav nav-tabs nav-justified nav-tabs-custom">
            <li><a href="manage-admin.php">Yöneticileri Yönet</a></li>
            <li><a href="admin-manage-user.php">Çalışanları Yönet</a></li>
          </ul>
          <div class="gap"></div>
          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <div class="well">
                <h3 class="text-center bg-primary" style="padding: 7px;">Çalışan Bilgilerini Düzenle</h3><br>
                        ...
                        <div class="col-md-7">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
                              <label class="control-label col-sm-2">Adı</label>
                              <div class="col-sm-8">
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-4 col-sm-3">
                                <button type="submit" name="update_current_employee" class="btn btn-success-custom">Güncelle</button>
                              </div>
                            </div>
                          </form> 
                        </div>
                        <div class="col-md-5">
                          <button id="emlpoyee_pass_btn" class="btn btn-primary">Şifre Değiştir</button>
                          <form action="" method="POST" id="employee_pass_cng">
                            <div class="form-group">
                              <label for="admin_password">Yeni Şifre:</label>
                              <input type="password" name="employee_password" class="form-control input-custom" id="employee_password" min="8" required>
                            </div>
                            <div class="form-group">
                              <button type="submit" name="btn_user_password" class="btn btn-success">Kaydet</button>
